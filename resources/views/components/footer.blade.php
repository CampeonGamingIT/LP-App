@props(['footer_domain_text'])

    <!--FOOTER--->
<footer>

    <div class='container py-5'>
        <p class='footer-text text-center'> @if(!empty($footer_domain_text)) {{ $footer_domain_text  . ' |'}} @endif All Rights Reserved © {{ date('Y') }} <br> 18+ | Gambling can be addictive. Play responsibly</p>
